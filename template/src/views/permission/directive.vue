<template>
  <div class="app-container">
    ...
    <div :key="'checkPermission' + key" style="margin-top: 60px">
      <aside>
        In some cases, using v-permission will have no effect. For example: Element-Plus's Tab component or el-table-column and other scenes that dynamically render dom. You can only do this with
        v-if.
        <br />
        e.g.
      </aside>
